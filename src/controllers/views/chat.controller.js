...
const getMessages = async (req, res) => {
    const user = req.user;
    res.render('pages/messagesIO', { email: user.email, role: user.role, notifications: req.flash(), use_chat: 1 });
}
...
//     const user = req.user;
//     console.log("🚀 ~ getMyMessages ~ user:", user)
//     let messages;
//     const allMessages = await chatsService.getMyMessages(user.email);
//     console.log("🚀 ~ getMyMessages ~ allMessages:", allMessages)
